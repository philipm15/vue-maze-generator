import {MazeCell} from "~/maze-generator/maze-cell";

export class MazeGenerator {
    public readonly cells: MazeCell[][] = [];
    ...
    get firstCell(): MazeCell {
        return this.cells[0][0];
    }

    get lastCell(): MazeCell {
        return this.cells[this.nRow - 1][this.nCol - 1];
    }

    get randomCell(): MazeCell {
    ...
    findPath(): MazeCell[] {
        ...
        const path: MazeCell[] = [this.firstCell];
    ...
    private mapNeighbors(cell: MazeCell): void {
        if (cell.row - 1 >= 0) {
